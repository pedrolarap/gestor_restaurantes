...
aplication = Tk()
aplication.geometry('1200x600+0+0')
aplication.resizable(0,0)
aplication.title('Gestor de Restaurantes')
...
#Ppanel costos
panel_costos = Frame(aplication, bd=1,relief=FLAT,bg='azure4')
...
lista_comidas = ['Arroz', 'Sopa', 'Res', 'Pavo']
lista_bebidas = ['Cereza', 'Lechoza', 'Fresa', 'Limón']
lista_postres = ['Flan', 'Brownies', 'Helado', 'Caramelo']
...
etiqueta_costo_comidas = Label(panel_costos,
                       text='Costo Comida',
                       font=('Dosis', 12, 'bold'),
                       bg='azure4',
                       fg='white')
